---
name: laravel-excel
description: "Use when building, modifying, testing, or debugging Laravel spreadsheet exports and imports with maatwebsite/excel. Activate for Excel::download(), store(), queue(), raw(), import(), toArray(), toCollection(), queueImport(), Exportable, Importable, FromCollection, FromQuery, FromView, FromArray, ToModel, ToCollection, OnEachRow, WithHeadingRow, WithMapping, WithValidation, WithChunkReading, WithBatchInserts, WithMultipleSheets, WithStyles, WithColumnFormatting, ShouldQueue, ShouldBatch, CSV settings, PhpSpreadsheet integration, Excel::fake(), export/import Artisan generators, config/excel.php, or package maintenance."
license: MIT
---
...
- Add `ShouldQueue` to exports/imports that may exceed request time limits.
