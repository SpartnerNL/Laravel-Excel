...
class ColumnTest extends TestCase
{
    ...
    public function readColumnTypes(): array
    {
        return [
            ...
            [RichText::make('RichText'), 'G2', 'test <span style="font-weight:bold; color:#000000; font-family:\'Calibri\'; font-size:12pt">test</span><span style="color:#000000; font-family:\'Calibri\'; font-size:12pt"> test</span>'],
