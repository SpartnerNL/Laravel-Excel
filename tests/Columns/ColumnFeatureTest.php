...
class ColumnFeatureTest extends TestCase
{
    /**
     * @test
    ...
    public function writeColumnTypes(): array
    {
        ...
        return [
            ...
            [Number::make('Attribute'), '10', DataType::TYPE_NUMERIC, 10],
            [Number::make('Attribute'), '10.50', DataType::TYPE_NUMERIC, 10],
            [Number::make('Attribute')->withDecimals(), '10.50', DataType::TYPE_NUMERIC, 10.5],
